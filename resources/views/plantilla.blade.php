...
<head>
  ...
  <!-- Se supone que funicona asi tambien bower_components/bootstrap/dist/css/bootstrap.min.css en todas-->
...
<body class="hold-transition skin-blue sidebar-mini login-page">
  ...
  <script type="text/javascript">
    ...
    "language":{
      ...
      "sInfo":"Monstrando registros del _START_al_END_de un total _TOTAL_",
