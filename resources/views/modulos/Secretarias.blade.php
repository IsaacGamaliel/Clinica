        ...
        <div class="modal-content">
            <form method="Post">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-danger" type="submit" data-dismiss="modal">Cerrar</button>
                </div>
            </form>
        </div>
    </div>
            ...
            <form method="Post" action="{{ url('actualizar-secretaria/'.$secretaria->id) }}">
                ...
                <div class="modal-body">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <h2>Nombre y Apellidos</h2>
                            <input type="text" class="form-control" name="name"  value="{{$secretaria->name}}">
                        </div>

                        <div class="form-group">
                            <h2>Email</h2>
                            <input type="email" class="form-control" name="email" value="{{$secretaria->email}}">
                            @error('email')
                                <div class="alert alert-danger">
                                    El email ya existe
                                </div>
